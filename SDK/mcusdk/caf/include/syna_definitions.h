...
--------------------------------------------------------------------------------
  ...
  File Name: syna_definitions.h

------------------------------------------------------------------------------*/
#ifndef SYNA_DEFINITIONS_H
#define SYNA_DEFINITIONS_H

#define _start_expose_ext_  //define the start line of blocks that will be exposted to customers
#define _end_expose_ext_    //define the end line of blocks that will be exposted to customers



#endif /*SYNA_DEFINITIONS_H*/
