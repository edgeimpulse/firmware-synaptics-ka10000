...
#define RPC_MODULE_ID_EXECUTOR  0x00
...
-----------  ------------ ------------------- --------------- ----------- - ----
| RSVD     |EVENT TYPE   |SENSOR TYPE |CPU ID |HW SENSOR ID| EVNT/RSP |MODULE ID|
------------------------- ----------------------------------------- ------------
 ---------USER DEFINED-------------------------------------|----COMMON-----------
*/
...
#define CPU_ID_NUM_BITS          3
#define CPU_ID_BIT_START_POS     5

#define GET_CPU_ID(X) (GETBITS(X,CPU_ID_BIT_START_POS,CPU_ID_NUM_BITS) )
#define SET_CPU_ID(X,cpu) (WRITETO(X,CPU_ID_BIT_START_POS,CPU_ID_NUM_BITS,cpu))
