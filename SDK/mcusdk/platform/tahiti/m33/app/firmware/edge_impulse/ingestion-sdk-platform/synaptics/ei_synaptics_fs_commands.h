#ifndef EI_SYNAPTICS_FS_COMMANDS_H
#define EI_SYNAPTICS_FS_COMMANDS_H

/* Include ----------------------------------------------------------------- */
#include <stdint.h>

#define SYNAPTICS_FS_BLOCK_ERASE_TIME_MS		90

/** Synaptics fs return values */
typedef enum
{
	SYNAPTICS_FS_CMD_OK = 0,						/**!< All is well				 */
	SYNAPTICS_FS_CMD_NOT_INIT,					/**!< FS is not initialised		 */
	SYNAPTICS_FS_CMD_READ_ERROR,					/**!< Error occured during read  */
	SYNAPTICS_FS_CMD_WRITE_ERROR,					/**!< Error occured during write */
	SYNAPTICS_FS_CMD_ERASE_ERROR,					/**!< Erase error occured		 */
	SYNAPTICS_FS_CMD_NULL_POINTER,				/**!< Null pointer parsed		 */
