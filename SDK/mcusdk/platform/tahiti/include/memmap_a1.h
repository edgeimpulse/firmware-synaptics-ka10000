...
#ifndef _MEMMAP_A0_H_
#define _MEMMAP_A0_H_
...
/* LLE's memory banks */
#define		AHB_LLEA_LOCAL_0_BASE_NS						0x41000000			// 4x8KB
#define		AHB_LLEA_LOCAL_0_SIZE_NS						0x00002000
#define		AHB_LLEA_LOCAL_1_BASE_NS						0x41002000
#define		AHB_LLEA_LOCAL_1_SIZE_NS						0x00002000
#define		AHB_LLEA_LOCAL_2_BASE_NS						0x41004000
#define		AHB_LLEA_LOCAL_2_SIZE_NS						0x00002000
#define		AHB_LLEA_LOCAL_3_BASE_NS						0x41006000
#define		AHB_LLEA_LOCAL_3_SIZE_NS						0x00002000

#define		AHB_LLEA_LOCAL_0_BASE_S							0x51000000			// 4x8KB
#define		AHB_LLEA_LOCAL_0_SIZE_S							0x00002000
#define		AHB_LLEA_LOCAL_1_BASE_S							0x51002000
#define		AHB_LLEA_LOCAL_1_SIZE_S							0x00002000
#define		AHB_LLEA_LOCAL_2_BASE_S							0x51004000
#define		AHB_LLEA_LOCAL_2_SIZE_S							0x00002000
#define		AHB_LLEA_LOCAL_3_BASE_S							0x51006000
#define		AHB_LLEA_LOCAL_3_SIZE_S							0x00002000
...
#define		AHB_CAPEB_LOCAL_0_BASE_NS						0x41300000			// 6x32KB
...
#define		AHB_CAPEB_LOCAL_4_BASE_NS						0x41320000
#define		AHB_CAPEB_LOCAL_4_SIZE_NS						0x00008000
#define		AHB_CAPEB_LOCAL_5_BASE_NS						0x41328000
#define		AHB_CAPEB_LOCAL_5_SIZE_NS						0x00008000
#define		AHB_CAPEB_ROM_BASE_NS							0x41330000
#define		AHB_CAPEB_ROM_SIZE_NS							0x00008000			// 32KB

#define		AHB_CAPEB_LOCAL_0_BASE_S						0x51300000			// 6x32KB
...
#define		AHB_CAPEB_LOCAL_4_BASE_S						0x51320000
#define		AHB_CAPEB_LOCAL_4_SIZE_S						0x00008000
#define		AHB_CAPEB_LOCAL_5_BASE_S						0x51328000
#define		AHB_CAPEB_LOCAL_5_SIZE_S						0x00008000
#define		AHB_CAPEB_ROM_BASE_S							0x51330000
#define		AHB_CAPEB_ROM_SIZE_S							0x00008000			// 32KB

/* Vector memory banks for LLE's */
#define		AHB_VECTOR_0_TO_4_BASE_NS						0x41400000
#define		AHB_VECTOR_0_TO_4_SIZE_NS						0x00050000			// 240KB - 24 bits per address
#define		AHB_VECTOR_0_TO_4_BASE_S						0x51400000
#define		AHB_VECTOR_0_TO_4_SIZE_S						0x00050000			// 240KB - 24 bits per address
...
/* Added here to be compatible with Z1 memory map for extra. These do not exist in A0 */
#define 	AHB_SHARED_MEM_BANK11_BASE						(AHB_SHARED_MEM_BANK9_BASE + AHB_SHARED_MEM_BANK9_SIZE)
#define 	AHB_SHARED_MEM_BANK11_SIZE						0x00010000			// 64KB
#define 	AHB_SHARED_MEM_BANK12_BASE						(AHB_SHARED_MEM_BANK9_BASE + AHB_SHARED_MEM_BANK9_SIZE)
#define 	AHB_SHARED_MEM_BANK12_SIZE						0x00010000			// 64KB
#define 	AHB_SHARED_MEM_BANK13_BASE						(AHB_SHARED_MEM_BANK9_BASE + AHB_SHARED_MEM_BANK9_SIZE)
...
#define		ASIP_CAPEA_LOCAL_0_BASE							0x00000000
...
#define		ASIP_CAPEA_ROM_SIZE								0x00004000

/* ASIP memory view of CAPEB */
#define		ASIP_CAPEB_LOCAL_0_BASE							0x00000000
...
#define		ASIP_CAPEB_LOCAL_4_BASE							0x00020000
#define		ASIP_CAPEB_LOCAL_4_SIZE							0x00008000
#define		ASIP_CAPEB_LOCAL_5_BASE							0x00028000
#define		ASIP_CAPEB_LOCAL_5_SIZE							0x00008000
#define		ASIP_CAPEB_ROM_BASE								0x00030000
#define		ASIP_CAPEB_ROM_SIZE								0x00008000
